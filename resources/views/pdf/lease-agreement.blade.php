...
<body>
    ...
    <p>
        ...
        No. <strong>{{ $tenant_ine !== '' ? $tenant_ine : '___________________________' }}</strong> como identificación oficial,
    ...
    <p>
        ...
        <span class="uppercase">«ARRENDATARIO»</span> a devolver el inmueble al <span class="uppercase">«ARRENDADOR»</span> en las mismas condiciones en las que las recibió,
    ...
    <p>
        ...
        falta de pago de mensualidad por dos meses consecutivos o adeuden por tres meses seguidos conceptos como cuota de mantenimientos, servicios de agua, luz u otro
        servicio involucrado, renuncian a su derecho de contestar, agilizando el trámite del proceso de desalojo del inmueble que arriendan. El
        <span class="uppercase">«ARRENDATARIO»</span> se compromete a abandonar el predio por vencimiento del contrato o por incumplimiento de dos meses de renta.
        ...
        En caso de no obtener respuesta, se emitirá una orden de desalojo a ejecutarse en 15 días hábiles. La renta impaga judicialmente reconocida origina su inscripción
        en el registro de Deudores Judiciales Morosos y tendrá vigencia hasta la extinción de la obligación.
    </p>
    ...
    <p>
        ...
        <strong>${{ $rent_amount_formatted }}</strong> ({{ $rent_amount_words }}) los días
    ...
    <p>
        <strong>SÉPTIMA. CONSERVACIÓN DEL INMUEBLE.</strong> <span class="uppercase">«EL ARRENDATARIO»</span> toma posesión del inmueble y responsabilidad de los gastos
        necesarios para el mantenimiento del inmueble, así como reparaciones necesarias y los servicios contratados o que se contraten para el buen funcionamiento del bien
    ...
    <p>
        ...
        conservarlas a su costa: limpieza e higiene del inmueble alquilado (cocina y equipo de cocina, recámaras, baños, regaderas y cuarto de lavado, así como su equipo),
        espacio de entrada y área común; en caso de contar con estacionamiento, mantenerlo limpio; área de basura, colocar la basura dentro del contenedor.
    </p>

    <p>
        <strong>OCTAVA. CASO FORTUITO O DE MAYOR FUERZA.</strong> Ninguna de las dos partes será responsable en caso de destrucción o deterioro del inmueble que impida su uso
    ...
    <p>
        <strong>8.1.</strong> <span class="uppercase">«EL ARRENDATARIO»</span> se hace responsable y toma conciencia sobre sanción por pérdida de llave del monto de
    ...
    <p>
        <strong>DÉCIMA.</strong> Queda prohibido realizar celebraciones, fiestas o reuniones en el área común o dentro de la casa habitación arrendada, siempre y cuando
        se respeten las siguientes reglas: por respeto a inquilinos vecinos, el ruido está prohibido después de las 22:00 hr; por respeto a inquilinos vecinos y limpieza
        e higiene común, todo rastro de basura debe ser colocado en el contenedor de basura, así como mantener el área común despejada de rastros de basura.
    </p>
    ...
    <p>
        ...
        regresarlas al estado original del inmueble.
    </p>
    ...
    <p>
        <strong>12.1.</strong> <span class="uppercase">«EL ARRENDATARIO»</span> deberá entregar los recibos de los servicios mencionados en la cláusula anterior, sin adeudo alguno.
    </p>
    <p>
        <strong>12.2.</strong> El depósito de <strong>${{ $deposit_amount_formatted }}</strong> ({{ $deposit_amount_words }}) no será devuelto en su totalidad en caso de
    ...
    <p>
        <span class="uppercase">«EL ARRENDATARIO»</span> tendrá la primera opción de renovar el contrato para el próximo periodo; deberá notificar con 30 días de anticipación
        al <span class="uppercase">«ARRENDADOR»</span>. Se hará un incremento del 7% sobre la tarifa. De requerir factura y realizar el pago por medio de transferencia se cobra el IVA (8%).
    </p>

    <p>
        <strong>DÉCIMO QUINTA.</strong> En caso de que <span class="uppercase">«EL ARRENDADOR»</span> necesite vender el inmueble, reparar o modificar su construcción,
    ...
    <p>
        <strong>DÉCIMO SEXTA. LEGISLACIÓN APLICABLE.</strong> Para el debido cumplimiento del objeto y condiciones del presente contrato, las partes se obligan a ajustarse
    ...
    <p>
        <strong>DÉCIMO SÉPTIMA. JURISDICCIÓN Y COMPETENCIA.</strong> Para la interpretación y cumplimiento del objeto y condiciones del presente contrato, así como para todo
    ...
    <p><strong>Anexos:</strong> Inventario y/o observaciones.</p>

    <table class="signature-table">
        <tr>
            <td>
                <span class="signature-line">{{ $landlord_name }}</span><br>
                <span class="uppercase">«EL ARRENDADOR»</span>
            </td>
            <td>
                <span class="signature-line">{{ $tenant_name }}</span><br>
                <span class="uppercase">«EL ARRENDATARIO»</span>
            </td>
        </tr>
    </table>
</body>
